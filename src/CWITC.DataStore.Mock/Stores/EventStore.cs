            ...
            Events.Add(new FeaturedEvent
                {
                    ...
                    Description = "Get ready for CWITC training with open registration and full system configuration prep throughout the day!",
