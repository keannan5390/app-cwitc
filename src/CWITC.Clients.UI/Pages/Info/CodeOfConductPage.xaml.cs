...
namespace CWITC.Clients.UI
{
    ...
    {
        public static string Conduct = "We want CWITC 2016 to be the best conference you’ve ever attended. In addition to great content, technical training, networking opportunities, and fun events, we want to make sure the conference is a safe and productive environment for all participants." +
